...
function readPreferences(tableId: string, defaults: TablePreferences): TablePreferences {
  ...
  try {
    ...
    return {
      ...
      filters: parsed.preferences.filters,
      grouping: parsed.preferences.grouping,
      activeViewId: parsed.preferences.activeViewId,
    };
  } catch {
    return defaults;
  }
...
function isStoredPreferences(value: unknown): value is StoredTablePreferences {
  ...
  return (
    ...
    Array.isArray(preferences.filters) &&
    Array.isArray(preferences.grouping) &&
    (preferences.activeViewId === null || typeof preferences.activeViewId === 'string') &&
